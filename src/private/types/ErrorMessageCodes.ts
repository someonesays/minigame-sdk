...
export const ErrorMessageCodesToText = {
  ...
  [ErrorMessageCodes.WS_CANNOT_BE_MORE_THAN_ONE_WINNER]:
    "Cannot be more than 1 winner.",
  [ErrorMessageCodes.WS_CANNOT_BE_MORE_THAN_ONE_SECOND]:
    "Cannot be more than 1 second place.",
  [ErrorMessageCodes.WS_CANNOT_BE_MORE_THAN_ONE_THIRD]:
    "Cannot be more than 1 third place.",
