...
export interface ServerTypes {
  ...
  [ServerOpcodes.MINIGAME_SET_PLAYER_STATE]: [number, State];
  [ServerOpcodes.MINIGAME_SEND_GAME_MESSAGE]: State;
  [ServerOpcodes.MINIGAME_SEND_PLAYER_MESSAGE]: [number, State];
  [ServerOpcodes.MINIGAME_SEND_PRIVATE_MESSAGE]: [number, number, State];
